...
CREATE TABLE `cpt` (
  ...
  FULLTEXT KEY `cptDesc` (`cptLongDesc`),
...
INSERT INTO `ins_provider` VALUES (1,'Blue Cross','','\r'),(2,'United Health Care ','UHC','\r'),(3,'Aetna','','\r'),(4,'Cigna','','\r'),(5,'Healthnet','','\r'),(6,'Blue Shield of California','','\r'),(7,'Hill Physicians Group ','this is an IPA','\r'),(8,'Beech Street Multiplan','','\r'),(9,'Coventry','','\r'),(10,'Corvel Health Network','','\r'),(11,'Affinity Health Plan ','this is an IPA','\r'),(12,'Humana','','\r'),(13,'Sutter Health Plan ','this is an IPA, with a new PPO/HMO product','\r'),(14,'Muir IPA ','this is an IPA','\r');
...
INSERT INTO `patient` VALUES (1,'ippo','dio','Ippokratis','Pandis','A','ippokratis@gmail.com',1,1,94301,'W21321','2014-03-30 07:00:01',''),(2,'kristina','123','Kristina','Serafim','','kristinaserafim@gmail.com',1,2,94301,'W21324','2014-03-30 07:00:02',''),(3,'nikos','123','Ippokratis','Pandis','A','zinas.nikos@gmail.com',1,1,95123,'W21325','2014-03-30 07:00:03',''),(4,'greg','123','Greg','Horner','','greg@feecast.com',1,1,91234,'W21326','2014-03-30 07:00:05',''),(5,'john','123','John','Doe','','jd@feecast.com',2,4,15312,'W21320','2014-03-30 07:00:06','');
