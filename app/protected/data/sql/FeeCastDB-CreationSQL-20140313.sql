...
CREATE TABLE IF NOT EXISTS `FeeCastDB`.`PhysReview` (
  ...
  CONSTRAINT `PHYREV_physician`
    FOREIGN KEY (`physician`)
    REFERENCES `FeeCastDB`.`Physician` (`phyLic`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `PHYREV_user`
    FOREIGN KEY (`user`)
    REFERENCES `FeeCastDB`.`Patient` (`patID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `FeeCastDB`.`PhysPricing` (
  ...
  CONSTRAINT `PHYPRIC_physician`
    FOREIGN KEY (`physician`)
    REFERENCES `FeeCastDB`.`Physician` (`phyLic`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `PHYPRIC_center`
    FOREIGN KEY (`center`)
    REFERENCES `FeeCastDB`.`Center` (`TIN`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `PHYPRIC_cpt`
    FOREIGN KEY (`cpt`)
    REFERENCES `FeeCastDB`.`CPT` (`cptCode`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
